...
sampleTable<-rbind(sampleTable,coh1Table)
...
pheatmap(sampleDistMatrix,
         ...
         col=colors,main="Sample to sample distance - using 10,000 genes with top avr counts")
...
pheatmap(assay(vsd)[select,], cluster_rows=FALSE, show_rownames=FALSE,cluster_cols=TRUE, annotation_col=df, main="Top 500 expressed genes (avr counts) - clustered by columns")
