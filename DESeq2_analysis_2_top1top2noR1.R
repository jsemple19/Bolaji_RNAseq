...
####
namePrefix <- "top1top2noR1_noOsc" #use _noOsc in prefix to automatically filter oscillating genes
...
sampleTable<-sampleTable[grep("TOP2_[m|p]_1",sampleTable$sampleName,invert=T),]
...
contrastsOI[["Top1AUXvsTIRAUX"]]<-Top1auxin-TIRauxin # general top1 effect (includes interaction term)
contrastsOI[["Top2AUXvsTIRAUX"]]<-Top2auxin-TIRauxin # general top2 effect (includes interaction term)
